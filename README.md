...
---
#### 소감<br><br>
프로젝트를 진행하는 동안 배운것을 토대로 혼자 진행하면서 어려웟던 부분이나, 막막했던 부분이 많았으나 공부가 많이 되었던 것 같습니다.
또한 컴퓨터 전공을 따로 배우지 않아 원리나 다른 개념들에 대해서도 독학하는 습관이 생겼으며 이같은 경험을 토대로
추후 취업이나 새로운 프로젝트를 맡게되었을 시 노력하는 사람, 계속하여 배우는 사람이 되도록 노력하겠습니다.
